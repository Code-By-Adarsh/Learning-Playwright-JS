...
I'm now upgrading my skillset to **Playwright + JavaScript** — a modern, faster, and increasingly in-demand automation stack — to strengthen my QA Automation career path.
...
- Learn Playwright from the ground up — locators, actions, assertions, fixtures, network handling
...
📌 Following this journey as I move toward QA Automation roles. Feedback and suggestions welcome!
